return {
  {
    ...
    keys = {
      ...
      { "č", function() require("harpoon.ui").nav_file(1) end, desc = "File 1" },
      { "ć", function() require("harpoon.ui").nav_file(2) end, desc = "File 2" },
      { "ž", function() require("harpoon.ui").nav_file(3) end, desc = "File 3" },
      -- { "š", function() require("harpoon.tmux").gotoTerminal(1) end, desc = "Terminal 1" },
      -- { "đ", function() require("harpoon.tmux").gotoTerminal(2) end, desc = "Terminal 2" },
